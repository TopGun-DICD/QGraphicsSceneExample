...
CustomListWidget::CustomListWidget(QWidget *parent) : QListWidget(parent) {
  ...
  p_li->SetTopText(tr("Top text 1"));
  p_li->SetBottomText(tr("Bottom text 1"));
  ...
  // Item 2
  p_li = new CustomListItem(it_itemGreen, tr("icons/icon_green_48.png"), tr("Top text 1"), tr("Bottom text 1"));
  ...
  // Item 3
  p_li = new CustomListItem(it_itemBlue, tr("icons/icon_blue_48.png"), tr("Top text 1"), tr("Bottom text 1"));
  ...
  // Item 4
  p_li = new CustomListItem(it_itemGrey, tr("icons/icon_grey_48.png"), tr("Top text 1"), tr("Bottom text 1"));
